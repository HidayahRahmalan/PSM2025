...
<head>
    ...
    <title>Data Correction Action Report</title>
...
<!-- timelineChart -->
<div class="container" style="padding: 100px 20px 20px 20px;">

    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px;">
        <h2 style="color:#ff9800; margin: 0;">Data Correction Actions Report</h2>
    ...
    <table id="actionsTable" class="display" style="width:100%;">
        ...
        <tbody>
            <?php
            $query = "SELECT a.ActionID, a.AType, a.ADetail, a.AStatus, a.ADate, a.RecordID, d.DSName
                      FROM action a
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr>
                        <td>" . htmlspecialchars($row['ActionID']) . "</td>
                        <td>" . htmlspecialchars($row['AType']) . "</td>
                        <!--<td>" . htmlspecialchars($row['ADetail']) . "</td>-->
                        <td>" . htmlspecialchars($row['AStatus']) . "</td>
...
<script>
    ...
    async function generatePDF() {
        ...
        pdf.text("Data Correction Actions Report", margin, currentY);
        currentY += 10;

        // Add Timeline Chart (your only chart)
        ...
        const dataTable = $('#actionsTable').DataTable();
        ...
        pdf.autoTable({
            ...
            didDrawPage: function (data) {
                if (data.pageNumber > 1) {
                    pdf.setFontSize(10);
                    pdf.text("Data Correction Actions Report", margin, 10);
                }
            }
        });

        // Save the PDF
        pdf.save("Data Correction Actions Report.pdf");
    }
    ...
    gradient.addColorStop(0, 'rgba(255, 152, 0, 0.5)'); // light orange
    gradient.addColorStop(1, 'rgba(255, 87, 34, 1)');   // deep orange
    ...
    const timelineChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                fill: false,
                borderColor: gradient, // use gradient here
                borderWidth: 2,
                tension: 0.2,
                pointBackgroundColor: '#ff9800',  // fill inside the dot
                pointBorderColor: '#ff5722',      // border of the dot
                backgroundColor: gradient         // fix for grey label color
            }]
        },
        options: {
            responsive: true,
            ...
            scales: {
                ...
                y: {
                    ...
                    title: {
                        ...
                        font: {
                            size: 14,
                            weight: 'bold' // 👈 makes 'Correction Count' bold
                        }
                    },
                    ticks: {
                        font: {
