...
<div class="table-wrapper">
    <h2 style="color:#ff9800;">Dataset List</h2>
    <table id="datasetTable" class="display" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['DSName']); ?></td>
                <td><?php echo htmlspecialchars($row['DSUploadDate']); ?></td>
                <td><?php echo htmlspecialchars($row['DSSource']); ?></td>
                <td><?php echo htmlspecialchars($row['DSFormat']); ?></td>
