...
<div class="table-wrapper">
    <h2 style="color:#ff9800;">Action List</h2>
    <table id="actionTable" class="display" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo htmlspecialchars($row['ActionID']); ?></td>
                <td><?php echo htmlspecialchars($row['AType']); ?></td>
                <!--<td><?php echo htmlspecialchars($row['ADetail']); ?></td>-->
                <td><?php echo htmlspecialchars($row['AStatus']); ?></td>
