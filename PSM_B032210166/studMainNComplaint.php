...
$sql = "SELECT r.ReqID, r.Type, r.Description, r.Status, r.RequestedDate, r.BookID, r.RoomID, 
...
$params = [$_SESSION['studID']];
$types = "s";

if ($searchCriteria === 'Type' && !empty($searchValue)) {
    $sql .= " AND r.Type = ?";
    $params[] = $searchValue;
    $types .= "s";
...
<head>
    ...
    <title>Maintenance & Complaint - SHMS</title>
    ...
    <style>
        ...
        /* Column Widths */
        th:nth-child(1), td:nth-child(1) { width: 8%; } /* ReqID */
        th:nth-child(2), td:nth-child(2) { width: 10%; } /* Type */
        th:nth-child(3), td:nth-child(3) { width: 16%; } /* Description */
        th:nth-child(4), td:nth-child(4) { width: 10%; } /* Status */
        th:nth-child(5), td:nth-child(5) { width: 10%; } /* RequestedDate */
        th:nth-child(6), td:nth-child(6) { width: 8%; } /* BookID */
        th:nth-child(7), td:nth-child(7) { width: 13%; } /* Room */
        th:nth-child(8), td:nth-child(8) { width: 10%; } /* Staff Name */
        th:nth-child(9), td:nth-child(9) { width: 5%; } /* Staff Role */
...
<body>
    ...
    <div class="container main-content">
        ...
        <section class="search-section">
            ...
            <form action="studMainNComplaint.php" method="GET" class="search-form">
                                ...
                                <td>
                                    <div class="action-buttons">
                                        <?php if ($request['Status'] === 'PENDING'): ?>
                                            <button class="btn btn-warning" onclick="editRequest('<?php echo $request['ReqID']; ?>')">Edit</button>
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="studProcessMainNComplaint.php">
    ...
    <div id="viewModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="viewEmpName">Employee Name</label>
                    <input type="text" id="viewEmpName" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label for="viewEmpRole">Employee Role</label>
                    <input type="text" id="viewEmpRole" class="form-control" readonly>
                </div>
            </div>
            <div class="modal-footer">
    ...
    <script>
        ...
        function editRequest(reqID) {
            ...
            fetch(`studGetMainNComplaintDetails.php?reqID=${reqID}`)
                ...
                .then(data => {
                    ...
                    updateCharCount(document.getElementById('description')); // Update character count
        ...
        function deleteRequest(reqID) {
            if (confirm('Are you sure you want to delete this request?')) {
                window.location.href = `studDeleteMainNComplaint.php?reqID=${reqID}`;
            }
        }
        ...
        function viewRequest(reqID) {
            ...
            fetch(`studGetMainNComplaintDetails.php?reqID=${reqID}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('viewEmpName').value = data.EmpName;
                    document.getElementById('viewEmpRole').value = data.EmpRole;
