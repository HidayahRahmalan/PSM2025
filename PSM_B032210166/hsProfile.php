    ...
    try {
        ...
        if (!$hasErrors) {
            ...
            if ($success) {
                ...
                header("Location: hsProfile.php?updated=true");
                exit();
            } else {
...
<head>
    ...
    <title>Hostel Staff Profile - SHMS</title>
    ...
    <main class="container main-content">
        ...
        <section class="profile-section">
            ...
            <div class="profile-info">
                <form action="hsProfile.php" method="POST">
    ...
    <div id="profilePicModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="profilePicForm" action="hsProcessUpdateProfilePic.php" method="POST">
    ...
    <script>
        ...
        fileInput.addEventListener("change", function(e) {
            ...
            if (!validTypes.includes(file.type)) {
                alert('Invalid file type. Please upload a JPEG, JPG, PNG, or GIF image.');
        ...
        // Form validation
        document.querySelector('form[action="hsProfile.php"]').addEventListener('submit', function(e) {
            e.preventDefault();
