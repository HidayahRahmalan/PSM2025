...
<head>
    ...
    <title>Hostel Staff Hostel & Room Management - SHMS</title>
...
<body>
    ...
    <main class="container main-content">
        ...
        <div class="management-cards">
            <div class="card" onclick="window.location.href='hsManageHostel.php'">
                ...
                <div class="card-content">
                    ...
                    <a href="hsManageHostel.php" class="btn">Manage Hostel</a>
                </div>
            </div>

            <div class="card" onclick="window.location.href='hsManageRoomChange.php'">
                ...
                <div class="card-content">
                    ...
                    <a href="hsManageRoomChange.php" class="btn">Manage Requests</a>
                </div>
            </div>
        </div>
    </main>
