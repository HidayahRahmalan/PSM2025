...
<body>
    ...
    <div class="container main-content">
        ...
        <section class="search-section">
            ...
            <form action="admMainNComplaint.php" method="GET" class="search-form">
    ...
    <script>
        ...
        function submitMainNComplaintForm(event) {
            ...
            // Send AJAX request
            fetch('admProcessMainNComplaint.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
        ...
        function viewRequest(reqID) {
            ...
            fetch(`admGetMainNComplaintDetails.php?reqID=${reqID}`)
        ...
        function deleteRequest(reqID) {
            if (confirm('Are you sure you want to delete this request?')) {
                window.location.href = `admDeleteMainNComplaint.php?reqID=${reqID}`;
            }
        }
        ...
        function acceptRequest(reqID) {
            if (confirm('Are you sure you want to accept this request?')) {
                window.location.href = `admAcceptMainNComplaint.php?reqID=${reqID}`;
            }
        }
