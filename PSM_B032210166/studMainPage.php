...
<head>
    ...
    <title>Student Login SHMS</title>
    <style>
        body {
        ...
        .image-container {
            flex: 1.73;
            background-image: url('utemsatria2.jpg');
...
<body>
    ...
    <div class="container">
        ...
        <div class="login-container">
            <h2>Welcome UTeM Student</h2>
            
            <form id="loginForm">
                <label for="email">Student Email:</label>
                <input type="email" id="email" name="email" placeholder="example@student.utem.edu.my" required pattern="[BbDd][0-9]{9}@student\.utem\.edu\.my" autocomplete="off">
                ...
                <div class="links-container">
                    <a href="studForgotPwd.php">Forgot Password?</a>
                    <a href="studReg.php">Create New Account</a>
                </div>
            </form>
        </div>
    </div>
        ...
        document.getElementById('loginBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    // Redirect to home page with StudID
                    setTimeout(function() {
