...
<head>
    ...
    <title>Hostel Staff View Semesters - SHMS</title>
    ...
    <style>
        ...
        * {
        ...
        @media print {
            header, .search-container, .btn-group, .modal, .add-semester-btn {
...
<body>
    ...
    <main class="container main-content">
        ...
        <section class="search-container">
            <form action="hsViewSem.php" method="GET" class="search-form">
                    ...
                    <tbody>
                        <?php foreach ($semesters as $semester): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="hsEditSem.php?id=<?php echo urlencode($semester['SemID']); ?>" class="btn btn-primary btn-sm">Edit</a>
    ...
    <script>
        ...
        function confirmDelete(semId) {
            if (confirm('Are you sure you want to delete this semester? This action cannot be undone.')) {
                window.location.href = "hsDeleteSem.php?id=" + encodeURIComponent(semId);
            }
        }
