...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: admViewSem.php");
        exit();
    }
        ...
        <div class="form-container">
            <form id="editForm">
                ...
                <div class="form-row button-group">
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='admViewSem.php'">Cancel</button>
        ...
        document.getElementById('editForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = 'admViewSem.php';
                } else {
