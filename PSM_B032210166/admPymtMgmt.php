...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_payment'])) {
    ...
    try {
        ...
        header("Location: admPymtMgmt.php?success=Payment updated successfully");
        exit();
    } catch (Exception $e) {
        error_log("Error updating payment: " . $e->getMessage());
        header("Location: admPymtMgmt.php?error=Failed to update payment: " . $e->getMessage());
        exit();
    }
}
?>
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            ...
            <div class="search-section">
                ...
                <form action="admPymtMgmt.php" method="GET" class="search-form">
    ...
    <div id="editPaymentModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editPaymentForm" action="admPymtMgmt.php" method="POST">
    ...
    <script>
        ...
        function viewPaymentProof(pymtID) {
            ...
            fetch('admGetPaymentProof.php?pymtID=' + pymtID)
                .then(response => {
                    if (!response.ok) {
        ...
        function editPayment(pymtID, status, amountPaid, balance) {
            ...
            fetch('admGetPaymentDetails.php?pymtID=' + pymtID)
        ...
        function sendPaymentReminder(studId, studentName, bookId) {
            if (confirm(`Send payment reminder to ${studentName} (${studId}) for booking ${bookId}?`)) {
                ...
                fetch('admSendPaymentReminder.php', {
                    method: 'POST',
                    headers: {
