...
<head>
    ...
    <title>Hostel Staff User Management - SHMS</title>
...
<body>
    ...
    <main class="container main-content">
        ...
        <section class="search-container">
            <form action="hsUserMgmt.php" method="GET" class="search-form">
                        ...
                        <tbody>
                            <?php foreach ($students as $student): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="hsEditStud.php?StudID=<?php echo $student['StudID']; ?>" class="btn btn-primary btn-sm">Edit</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
