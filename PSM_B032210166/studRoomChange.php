...
<head>
    ...
    <title>Room Change Requests - SHMS</title>
    ...
    <style>
        ...
        th:nth-child(5), td:nth-child(5) { width: 8%; } /* BookID */
        th:nth-child(6), td:nth-child(6) { width: 15%; } /* Room */
        th:nth-child(7), td:nth-child(7) { width: 10%; } /* Staff Name */
        th:nth-child(8), td:nth-child(8) { width: 9%; } /* Staff Role */
...
<body>
    ...
    <div class="container main-content">
        ...
        <section class="search-section">
            ...
            <form action="studRoomChange.php" method="GET" class="search-form">
    ...
    <div id="editModal" class="modal">
        <div class="modal-content">
            ...
            <form id="editForm" method="POST" action="studProcessRoomChange.php">
    ...
    <script>
        ...
        function editRequest(reqID) {
            ...
            fetch(`studGetRequestDetails.php?reqID=${reqID}`)
        ...
        function deleteRequest(reqID) {
            if (confirm('Are you sure you want to delete this request?')) {
                window.location.href = `studDeleteRequest.php?reqID=${reqID}`;
            }
        }
