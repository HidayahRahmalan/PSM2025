...
<body>
    ...
    <main class="container">
        ...
        <section class="search-container">
            <form action="hsManageRoom.php" method="GET" class="search-form">
    ...
    <script>
        ...
        document.getElementById('roomForm').addEventListener('submit', function(e) {
            ...
            // Get existing rooms from PHP
            const existingRooms = <?php echo json_encode($rooms); ?>;
