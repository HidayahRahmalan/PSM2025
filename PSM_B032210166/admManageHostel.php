...
<head>
    ...
    <title>Admin Manage Hostel - SHMS</title>
    ...
    <style>
        ...
        * {
        ...
        @media print {
            header, .search-container, .btn-group, .modal {
...
<body>
    ...
    <main class="container main-content">
        ...
        <section class="search-container">
            <form action="admManageHostel.php" method="GET" class="search-form">
    ...
    <script>
        ...
        function viewRooms(hostID) {
            window.location.href = `admManageRoom.php?hostID=${hostID}`;
        }
