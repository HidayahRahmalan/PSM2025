...
<body>
    ...
    <div class="container main-content">
        ...
        <section class="search-section">
            ...
            <form action="hsManageRoomChange.php" method="GET" class="search-form">
    ...
    <script>
        ...
        function editRequest(reqID) {
            ...
            fetch(`hsGetRequestDetails.php?reqID=${reqID}`)
        ...
        function deleteRequest(reqID) {
            if (confirm('Are you sure you want to delete this request?')) {
                window.location.href = `hsDeleteRequest.php?reqID=${reqID}`;
            }
        }
        ...
        function fetchRoomDetails(roomID) {
            fetch(`hsGetRoomDetails.php?roomID=${roomID}`)
                .then(response => response.json())
                .then(data => {
                    if (!data.success) {
