    ...
    <div class="container">
        ...
        <div id="step1" class="step active">
            ...
            <form id="emailForm">
                ...
                <input type="email" id="email" name="email" placeholder="example@student.utem.edu.my" 
                       required pattern="[BbDd][0-9]{9}@student\.utem\.edu\.my" autocomplete="off">
    ...
    <script>
        ...
        document.getElementById('sendVerificationBtn').addEventListener('click', function() {
            ...
            if (!email || !emailPattern.test(email)) {
                messageDiv.textContent = 'Please enter a valid UTeM student email.';
                return;
            }
            ...
            fetch('studProcessForgotPwd.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
        ...
        document.getElementById('resetPasswordBtn').addEventListener('click', function() {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    setTimeout(function() {
                        window.location.href = 'studMainPage.php';
                    }, 3000);
                } else {
