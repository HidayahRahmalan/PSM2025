...
// Redirect if not logged in or not hostel staff, but only if not being included by another file
if (basename($_SERVER['PHP_SELF']) === 'hsSendBookingStatusEmail.php' && 
    (!isset($_SESSION['empId']) || !isset($_SESSION['role']) || $_SESSION['role'] !== 'HOSTEL STAFF')) {
    ...
    try {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            try {
                ...
                // Recipients
                $mail->setFrom('foodddt@gmail.com', 'UTeM SHMS Hostel Staff');
