...
if (isset($_GET['StudID'])) {
    ...
    header("Location: hsUserMgmt.php?error=No student selected");
    exit();
}
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: hsUserMgmt.php?error=" . urlencode("Student with ID $studID not found."));
        exit();
    }
    ...
    try {
        ...
        if (!$hasErrors) {
            ...
            if ($success) {
                ...
                header("Location: hsEditStud.php?StudID=" . urlencode($studID) . "&updated=true");
                exit();
            } else {
                // If update failed, redirect back with error
                header("Location: hsEditStud.php?StudID=" . urlencode($studID) . "&error=Failed to update student information");
                exit();
            }
...
<body>
        ...
        <div class="container">
            <div class="navbar">
                <div style="display: flex; align-items: center;">
                    <button class="btn btn-primary" onclick="window.location.href='hsUserMgmt.php'" style="margin-right: 15px;">
    ...
    <main class="container">
        ...
        <section class="profile-section">
            ...
            <div class="profile-info">
                <form action="hsEditStud.php" method="POST">
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='hsUserMgmt.php'">Cancel</button>
    ...
    <script>
        ...
        document.querySelector('form[action="hsEditStud.php"]').addEventListener('submit', function(e) {
            e.preventDefault();
