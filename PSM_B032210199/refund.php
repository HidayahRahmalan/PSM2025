...
<div class="table-wrapper">
    <h2 style="color:#ff9800;">Refund List</h2>
    <table id="Table" class="display" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                <td><?php echo htmlspecialchars($row['RefundID']); ?></td>
                <td><?php echo htmlspecialchars($row['OrderID']); ?></td>
                <td><?php echo htmlspecialchars($row['ProductName']); ?></td>
                <td><?php echo htmlspecialchars($row['ReturnRequestDate']); ?></td>
                <td><?php echo htmlspecialchars($row['RefundAmount']); ?></td>
                <td><?php echo htmlspecialchars($row['ReasonForReturn']); ?></td>
                <td><?php echo htmlspecialchars($row['ReturnStatus']); ?></td>
