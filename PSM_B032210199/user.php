...
<?php
// Fetch admins
$sqlAdmin = "SELECT UserID, UName, UEmail FROM `USER` WHERE URole = 'ADMIN'";
$resultAdmin = $conn->query($sqlAdmin);

// Fetch users
$sqlUser = "SELECT UserID, UName, UEmail FROM `USER` WHERE URole = 'USER'";
...
<div class="table-wrapper">
    <h2 style="color:#ff9800;">Admin Users</h2>
    ...
    <h2 style="color:#ff9800;">Regular Users</h2>
