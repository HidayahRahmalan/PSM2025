...
<div class="table-wrapper">
    <h2 style="color:#ff9800;">Payout List</h2>
    <table id="Table" class="display" style="width:100%;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['GrossSalesAmount']); ?></td>
                <td><?php echo htmlspecialchars($row['PlatformFees']); ?></td>
                <td><?php echo htmlspecialchars($row['TransactionFees']); ?></td>
                <td><?php echo htmlspecialchars($row['ShippingFees']); ?></td>
                <td><?php echo htmlspecialchars($row['RefundsIssued']); ?></td>
                <td><?php echo htmlspecialchars($row['NetPayoutAmount']); ?></td>
