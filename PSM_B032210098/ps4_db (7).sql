...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 03, 2025 at 10:35 AM
...
CREATE TABLE IF NOT EXISTS `consoles` (
  `console_ID` varchar(10) NOT NULL,
  `console_name` varchar(50) NOT NULL,
  `console_model` varchar(50) DEFAULT NULL,
  `location_description` varchar(255) DEFAULT NULL,
  `max_controllers` int NOT NULL DEFAULT '4',
  `consoles_status` enum('available','in_use','maintenance') NOT NULL DEFAULT 'available',
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  `customer_matric_no` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `games` (
  ...
  `game_video_trailer` varchar(255) DEFAULT NULL,
...
('PAY0001', NULL, 4.00, '2025-06-25 06:30:15', 'FPX', 'completed', 'uploads/payment_proofs/RENT0003_1751179726.pdf', 'TXN001234567890'),
('PAY0002', NULL, 6.00, '2025-06-26 08:45:22', 'FPX', 'completed', 'uploads/payment_proofs/RENT0004_1751204278.pdf', 'TXN001234567891'),
('PAY0003', NULL, 8.00, '2025-06-27 02:15:33', 'FPX', 'completed', 'uploads/payment_proofs/RENT0005_1751136219.pdf', 'TXN001234567892'),
('PAY0004', NULL, 2.00, '2025-06-28 11:20:45', 'FPX', 'completed', 'uploads/payment_proofs/RENT0006_1751179727.pdf', 'TXN001234567893'),
('PAY0005', NULL, 10.00, '2025-06-29 03:30:12', 'FPX', 'completed', 'uploads/payment_proofs/RENT0007_1751204279.pdf', 'TXN001234567894'),
('PAY0006', NULL, 4.00, '2025-06-30 07:45:28', 'FPX', 'completed', 'uploads/payment_proofs/RENT0008_1751136220.pdf', 'TXN001234567895'),
('PAY0007', NULL, 6.00, '2025-07-01 01:10:55', 'FPX', 'completed', 'uploads/payment_proofs/RENT0009_1751179728.pdf', 'TXN001234567896'),
('PAY0008', NULL, 8.00, '2025-07-02 05:25:18', 'FPX', 'completed', 'uploads/payment_proofs/RENT0010_1751204280.pdf', 'TXN001234567897'),
('PAY0009', NULL, 2.00, '2025-07-03 09:40:42', 'FPX', 'completed', 'uploads/payment_proofs/RENT0011_1751136221.pdf', 'TXN001234567898'),
('PAY0010', NULL, 12.00, '2025-07-04 12:55:33', 'FPX', 'completed', 'uploads/payment_proofs/RENT0012_1751179729.pdf', 'TXN001234567899'),
('PAY0011', NULL, 4.00, '2025-07-05 00:15:27', 'FPX', 'completed', 'uploads/payment_proofs/RENT0013_1751204281.pdf', 'TXN001234567900'),
('PAY0012', NULL, 6.00, '2025-07-06 04:30:44', 'FPX', 'completed', 'uploads/payment_proofs/RENT0014_1751136222.pdf', 'TXN001234567901'),
('PAY0013', NULL, 8.00, '2025-07-07 08:45:19', 'FPX', 'completed', 'uploads/payment_proofs/RENT0015_1751179730.pdf', 'TXN001234567902'),
('PAY0014', NULL, 2.00, '2025-07-08 13:00:36', 'FPX', 'completed', 'uploads/payment_proofs/RENT0016_1751204282.pdf', 'TXN001234567903'),
('PAY0015', NULL, 10.00, '2025-07-08 23:25:53', 'FPX', 'completed', 'uploads/payment_proofs/RENT0017_1751136223.pdf', 'TXN001234567904'),
('PAY0016', NULL, 4.00, '2025-07-10 03:40:08', 'FPX', 'completed', 'uploads/payment_proofs/RENT0018_1751179731.pdf', 'TXN001234567905'),
('PAY0017', NULL, 6.00, '2025-07-11 06:55:25', 'FPX', 'completed', 'uploads/payment_proofs/RENT0019_1751204283.pdf', 'TXN001234567906'),
('PAY0018', NULL, 8.00, '2025-07-12 10:10:47', 'FPX', 'completed', 'uploads/payment_proofs/RENT0020_1751136224.pdf', 'TXN001234567907'),
('PAY0019', NULL, 2.00, '2025-07-13 14:25:14', 'FPX', 'completed', 'uploads/payment_proofs/RENT0021_1751179732.pdf', 'TXN001234567908'),
('PAY0020', NULL, 12.00, '2025-07-13 22:50:31', 'FPX', 'completed', 'uploads/payment_proofs/RENT0022_1751204284.pdf', 'TXN001234567909'),
('PAY0257', NULL, 4.00, '2025-08-22 07:08:03', 'FPX', 'completed', 'uploads/payment_proofs/RENT0025_1755846483.pdf', NULL),
('PAY1026', NULL, 4.00, '2025-07-02 04:09:25', 'FPX', 'completed', 'uploads/payment_proofs/RENT0028_1751429365.pdf', NULL),
('PAY1636', NULL, 4.00, '2025-07-02 04:10:17', 'FPX', 'completed', 'uploads/payment_proofs/RENT0027_1751429417.pdf', NULL),
('PAY2120', NULL, 2.00, '2025-08-28 03:59:59', 'FPX', 'completed', 'uploads/payment_proofs/RENT0026_1756353599.pdf', NULL),
('PAY3905', NULL, 6.00, '2025-08-28 05:00:31', 'FPX', 'completed', 'uploads/payment_proofs/RENT0027_1756357231.pdf', NULL),
('PAY3949', NULL, 2.00, '2025-06-29 06:48:46', 'FPX', 'completed', 'uploads/payment_proofs/RENT0001_1751179726.pdf', NULL),
('PAY4933', NULL, 4.00, '2025-07-02 03:42:19', 'FPX', 'completed', NULL, NULL),
('PAY6100', NULL, 4.00, '2025-07-02 03:35:43', 'FPX', 'completed', 'uploads/payment_proofs/RENT0025_1751427343.pdf', NULL),
('PAY6208', NULL, 8.00, '2025-06-29 13:37:58', 'FPX', 'completed', 'uploads/payment_proofs/RENT0002_1751204278.pdf', NULL),
('PAY7402', NULL, 2.00, '2025-07-02 03:51:10', 'FPX', 'completed', 'uploads/payment_proofs/RENT0026_1751428270.pdf', NULL),
('PAY7760', NULL, 4.00, '2025-07-02 04:08:09', 'FPX', 'completed', 'uploads/payment_proofs/RENT0027_1751429289.pdf', NULL),
('PAY7796', NULL, 6.00, '2025-08-21 06:16:33', 'FPX', 'completed', 'uploads/payment_proofs/RENT0024_1755756993.pdf', NULL);
...
CREATE TABLE IF NOT EXISTS `rentals` (
  ...
  `rental_status` enum('pending_payment','confirmed','in_progress','completed','cancelled') NOT NULL DEFAULT 'pending_payment',
  `customer_ID` varchar(10) NOT NULL,
  `console_ID` varchar(10) NOT NULL,
  `staff_ID` varchar(10) DEFAULT NULL,
